/**
 * Created by Josefinetusindfryd on 14/04/16.
 */
...
public class KMPAlgo {
    ...
    // Tanke to
    public int searchSubStringS(char[] text, char[] ptrn1, char[] ptrn2) {
        int i = 0, j = 0;

        int Len1 = ptrn1.length;
        int Len2 = ptrn2.length;
        char[] ptrn = new char[Len1+Len2];
        System.arraycopy(ptrn1, 0, ptrn, 0, Len1);
        System.arraycopy(ptrn2, 0, ptrn, Len1, Len2);
